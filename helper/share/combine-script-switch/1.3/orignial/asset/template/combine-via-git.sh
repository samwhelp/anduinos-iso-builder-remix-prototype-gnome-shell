...
REF_WORK_DIR_PATH="${HOME}/work/anduinos-iso-builder-remix-prototype-gnome-shell"
...
echo "[Next Step]: cd ~/work/anduinos-iso-builder-remix-prototype-gnome-shell/iso-profile
"
echo
